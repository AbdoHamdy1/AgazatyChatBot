...
class LeaveChatbot:
    ...
    def get_response(self, user_input):
        ...
        if (
            any(word in normalized for word in ["معلومات", "تفاصيل", "ايه هي", "ما هي"]) and
            any(word in normalized for word in ["وفاة", "حداد", "ميت", "موت"])
        ):
        ...
        if any(phrase in normalized for phrase in ["تعرف اجازات", "عارف اجازات", "تفهم في الاجازات","تفهم الاجازات" ,"عندك معلومات عن الاجازات", "انت على معرفة بالاجازات"]):
        ...
        elif any(word in normalized for word in ["وفاه", "وفاة", "حداد"]):
            return self.responses.get("death_leave")
        elif any(word in normalized for word in ["زواج", "جواز", "فرح"]):
